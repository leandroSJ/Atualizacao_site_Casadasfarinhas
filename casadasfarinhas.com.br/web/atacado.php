...
<body>
            ...
            <div class="container py-3">
                ...
                <div class="collapse navbar-collapse" id="navbar-items">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" href="atacado.php">Atacado</a>
                        </li>                        
                        <li class="nav-item">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 text-center">                
                    <h1 class="heading-section mb-5 pb-md-4">Promoção</h1>
                </div>
                <div class="col-md-12">
                    <div class="featured-carousel owl-carousel">

                        <?php 
                            for($i=0; $i < $qtd_ofertas_atacado; $i++){
                                foreach ($result_ofertas_atacado[$i] as $key => $value){}
                                $foto_ofertas_atacado = $result_ofertas_atacado[$i]['foto'];
                            

                                echo "<div class='item'>";
                                echo "<div class='work' >";
                                echo "<div class='col-12 img d-flex align-items-center justify-content-center rounded'>";                                
                                echo "<img src='auth/painel/img/slider_ofertas_atacado/$foto_ofertas_atacado' style='height: 330px;' alt=''>";                                
                                echo "</div>";                                
                                echo "</div>";
                                echo "</div>";
    ...
    <section style="background-color: #eee;">
        <div class="text-center container py-5">
            <h4 class="mt-4 mb-5"><strong>Mais Vendidos</strong></h4>
            <div class="row">
                <?php 
                    for($i=0; $i < $qtd_produtos_atacado; $i++){
                        foreach ($result_produtos_atacado[$i] as $key => $value){}
                        $foto_produtos_atacado = $result_produtos_atacado[$i]['foto'];
                        $cat_produtos_atacado = $result_produtos_atacado[$i]['categoria'];
                        $nome_produtos_atacado = $result_produtos_atacado[$i]['nome'];   
                        $ean_produtos_atacado = $result_produtos_atacado[$i]['ean'];   
            
                        $query2 = $pdo->query("SELECT * FROM cat_produtos where id = '$cat_produtos_atacado'");
                        ...
                        <div class="col-lg-4 col-md-12 mb-4">
                            ...
                            <div class="bg-image hover-zoom ripple ripple-surface ripple-surface-light"
                                ...
                                <img src="auth/painel/img/produtos_atacado/$foto_produtos_atacado" alt="" class="w-100">                                
                            </div>
                            <div class="card-body">
                                <a href="" class="text-reset">
                                    <h5 class="card-title mb-3">$nome_produtos_atacado</h5>
                                </a>
                                <a href="" class="text-reset">
                                    <p>$nome_cat</p>
                                </a>
                                <h6 class="mb-3">EAN: $ean_produtos_atacado</h6>
                            </div>
                            </div>
                        </div> 
                        HTML;                       
