...
<tr>
	<td>
		<img src="img/slider_ofertas_atacado/{$foto}" width="200px" class="mr-2">		
	</td>
...
<script type="text/javascript">
	function editar(id, foto){
		...
		$('#foto').val('');
		$('#target').attr('src','img/slider_ofertas_atacado/' + foto);
	}
	...
	function limparCampos(){
		...
		$('#target').attr('src','img/slider_ofertas_atacado/sem-foto.jpg');
...
<script type="text/javascript">
	function mostrar(id, foto, foto){		
		...
		$('#target_mostrar').attr('src','img/slider_ofertas_atacado/' + foto);
