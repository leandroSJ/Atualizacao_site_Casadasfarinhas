...
<body>
    ...
    <section style="background-color: #eee;" >    
        <div class="text-center container py-5">
            <h4 class="mt-4 mb-5"><strong>Higiene Pessoal</strong></h4>                      
            <div class="row">
                <?php
                    $query_produtos = $pdo->query("SELECT * FROM produtos where categoria = 7");
                    ...
                    for($i=0; $i < $qtd_produtos; $i++){
                        ...
                        echo" <img src='auth/painel/img/produtos/$foto_produtos' alt='' class='w-100'>";
                        echo" </div>";
                        echo" <div class='card-body'>";
                        echo"    <a href='' class='text-reset'>";
                        echo"        <h5 class='card-title mb-3'>$nome_produtos</h5>";
                        echo"    </a>";
                        echo"    <a href='' class='text-reset'>";
                        echo"        <p>$nome_cat</p>";
                        echo"    </a>";
                        echo"    <h6 class='mb-3'>EAN: $ean</h6>";
                        echo" </div>";
                        echo" </div>";
                        echo" </div>";
